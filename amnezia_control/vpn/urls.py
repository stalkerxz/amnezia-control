...
from .views import (
    ...
    client_download_native_config_view,
    ...
    renewal_request_attachment_download_view,
)
...
urlpatterns = [
    ...
    path(
        ...
        renewal_request_attachment_download_view,
        name="renewal-request-attachment-download",
    ),
    ...
    path("<int:pk>/download/native/", client_download_native_config_view, name="clients-download-native"),
